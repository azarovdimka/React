...
const hmpServer = express();                                                                                             // создали hmr сервер
...
hmrServer.use(webpackDevMiddleware(clientCompiler, {                                                                //use для подключения сторонних middleware
    ...
    writeToDisk: true,
    stats: 'error-only'                                                                                                  // error-only - инфа только об ошибках, выключает логи успешной компиляции, там много ненужной информации
}));
